...
<table style="border-collapse: collapse;">
  <tr>
    <td style="border: none;">
      <p> I'm Akarsh, an AI Engineer specializing in Mobile Application(Flutter), Backend(Fastapi) MachineLearning. I enjoy exploring the latest in UI design, AI automation, Machine Learning, and Data Analytics, HFT. My projects reflect my commitment to building impactful, user-centric solutions. I’m always learning and open to new challenges. Let’s collaborate and innovate together!</p>
    </td>
    <td style="border: none;">
